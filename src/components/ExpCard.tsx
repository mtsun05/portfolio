...
const ExpCard = ({ children, title, company, imgLink }: ExpCardProps) => {
  return (
    <div className="group flex flex-col bg-[#e6e6e6] dark:bg-[#151515] rounded-lg p-5 my-2 text-black hover:ring-1 ring-neutral-600 dark:text-white transition-all duration-300 cursor-default">
